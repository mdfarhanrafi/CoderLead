  ...
  const onSubmit = async (data: z.infer<typeof signInSchema>) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        router.push("/problem") // Redirect to the dashboard or home page after successful sign-in
      } else {
    ...
    <Card className="w-full max-w-md border border-gray-200 bg-gray-50 shadow-xl">
      <CardHeader className="flex flex-col gap-1 items-center pb-2">
        ...
        <CardDescription className="text-gray-500 text-center">
          Sign in to have access to your account and continue where you left off.
        </CardDescription>
      </CardHeader>
